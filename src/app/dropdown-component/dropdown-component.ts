...
export class DropdownComponent {
  ...
  get baseClasses():string{
    ...
    const baseClasses = 'drop-down w-full h-[600px] bg-white fixed top-24 left-0 flex items-center justify-center shadow-xl transition-all duration-300 ease-in-out';
